...
const IndexPage = ctx => {
    ...
    */
        ...
        axios(`${
            process.env.BACKEND_SERVICE_DOMAIN
        }/api/userinfo`, {withCredentials: true}).then(resp => {
            setModalIsOpen(false);
    ...
    return (
      ...
      모든 단순암기시험이 사라지는 그날까지 여러분을 응원합니다.`}
                ...
                <ul style={
                    ...
                    <li>
                        암기를 할 수 있도록 연습문제 풀기</li>
                    <li>
                        암기 상태를 점검할 수 있는 모의고사</li>
                    <li>
                        어디를 덜 외웠는지 확인할 수 있는 암기점검 기능</li>
                    <li>
